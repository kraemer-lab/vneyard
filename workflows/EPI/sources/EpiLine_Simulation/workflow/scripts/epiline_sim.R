...
option_list <- list(
  ...
  make_option(
    ...
    type = "character",
    default = "2020-04-01",
    help = "Start date of reporting"
  ),
  make_option(
    c("--duration"),
    type = "integer",
    default = 50,
    help = "Number of days for which data is reported"
  ),
  make_option(
    c("--pre-symptom"),
    type = "integer",
    default = 30,
    help = "Days before reporting period to simulate"
  ),
  make_option(
    c("--post-symptom"), 
    type = "integer",
    default = 5, 
    help = "Days after reporting period to simulate"
  ),
  make_option(
    c("--symptomatic"),
    type = "integer",
    default = 2,
    help = "Initial number of symptomatic individuals"
  )
)
