...
option_list <- list(
  ...
  make_option(
    ...
    type = "character",
    default = "0.1, 0.5, 0.9",
    help = "Quantiles to plot"),
  make_option(
    c("-p", "--plot-delay"),
    type = "integer",
    default = 15,
    help = "Delay in seconds before taking a screenshot of the plot"
  ),
  make_option(
    c("-d", "--date-of-report"),
    type = "character",
  ...
  make_option(
    c("-r", "--reported-file"),
    type = "character",
    help = "Filename of reported cases"
  ),
  make_option(
    c("-l", "--linelist-file"),
    type = "character",
    help = "Filename of line list (report date, symptom date)"),
  make_option(
    c("--mcmc-samples"),
    type = "integer",
    default = 100,
